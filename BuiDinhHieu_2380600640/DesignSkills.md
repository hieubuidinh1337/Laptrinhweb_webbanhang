...
RULE T3 — Sentence case everywhere.
  ...
  Exception: brand name "DinhHieu" in logo lockup only.
...
Rules:
- Brand name: Cormorant Garamond, 1.5rem, tracking 0.22em — display ONLY as "DinhHieu"
...
```
┌─────────────────────────────────────────────────────────────────────┐
│  DinhHieu DESIGN QUICK REFERENCE                                     │
├─────────────┬───────────────────────────────────────────────────────┤
...
_DinhHieu DESIGN SKILL v1.0 — Load this file before every UI task._  
