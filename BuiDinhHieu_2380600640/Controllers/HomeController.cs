...
using BuiDinhHieu_2380600640.Models;
...
namespace BuiDinhHieu_2380600640.Controllers
{
    public class HomeController : Controller
    {
        ...
        public async Task<IActionResult> Categories()
        {
            ...
            ViewData["Description"] = "Khám phá toàn bộ danh mục sản phẩm thủ công tinh xảo của DinhHieu Atelier — Túi xách, Đồng hồ, Lụa & Cashmere và nhiều hơn nữa.";
